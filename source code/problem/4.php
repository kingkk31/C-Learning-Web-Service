...
<html>
	...
	<form action="grader.php" method="post" id="form">
		<div id="name"><h2>문제<input name="no" value="<?php $url = basename($_SERVER['PHP_SELF']); $tok = explode('.', $url);	echo trim($tok[0]); ?>
					...
					?></h2></div>
		<aside>
			<p style="margin:2%;margin-right:6%;font-size:13px;line-height:1.5em;"><strong style="font-size:16px;">[문 제]</strong><br/><br/>꽤나 화려한 대학 생활을 보내고 있는 우리의 친구 한신이는, 종강 후 받은 이번 학기 성적들을 보며 자신의 앞날을 걱정하게 되었다. 착잡해진 한신이는 여태까지 받은 전체 평점들의 평균 평점을 알아보려 했으나 갑작스런 전산 오류로 인해 성적표가 열리지 않게 되었다. 머리가 복잡 할 한신이를 대신하여 전체 평균 평점을 구해주다.<br/><br/>입력의 첫줄에 여태까지 다닌 학기의 수가 주어진다. 학기는 최소 1학기부터 최대 8학기까지 존재한다.<br/>다음줄에는 각 학기의 평점이 주어진다. 평점은 0부터 4.5까지의 실수이며 소수 둘째자리까지 나타날 수 있다.<br/><br/>출력으로 나올 평균 평점은 반올림하여 소수 둘째자리까지 나타내야 하며, 정확한 답을 구하기 위해 정밀한 자료형을 사용해야 한다.</p>
<br/><br/>
					<p style="margin:2%;font-size:16px;line-height:1.5em;"><strong>[예제 입력]<br/></strong>4<br/>3.5 3.33 2.9 2.75<br/></p>
					<br/><br/>
					<p style="margin:2%;font-size:16px;line-height:1.5em;"><strong>[예제 출력]<br/></strong>3.12<br/></p>
					<br/><br/>
		</aside>
		<section>
				&nbsp;&nbsp;&nbsp;문제푸는 곳<br/>
