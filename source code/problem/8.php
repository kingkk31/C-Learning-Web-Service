...
<html>
	...
	<form action="grader.php" method="post" id="form">
		<div id="name"><h2>문제<input name="no" value="<?php $url = basename($_SERVER['PHP_SELF']); $tok = explode('.', $url);	echo trim($tok[0]); ?>
					...
					?></h2></div>
		<aside>
			<p style="margin:2%;margin-right:6%;font-size:13px;line-height:1.5em;"><strong style="font-size:16px;">[문 제]</strong><br/><br/>한신이의 친구 한수는 사탕을 매우 좋아한다. 평소 꽤나 불성실한 학교 생활을 하던 한신이는 이제야 과제 제출일 전까지 n일밖에 남지 않았다는 것을 깨닫고 한수에게 도움을 청하게 되었다. 한수는 자신에게 첫 날 사탕을 a개 주고 매일마다 전날의 사탕보다 d개씩 개수를 늘려서 n일 동안 사탕을 준다면 과제를 도와주겠다고 제안했다. 셈에 약한 한신이를 대신해 한수를 위해 얼마만큼의 사탕을 준비해야 하는지 구해보자.<br/><br/>입력은 차례로 첫 날 사탕의 수 a와 증가하는 사탕의 양 d, 과제 제출일 전까지의 날짜 n이 주어진다.<br/>(0 <= a, d <= 10, 0 < n <= 30)</p>
<br/><br/>
					<p style="margin:2%;font-size:16px;line-height:1.5em;"><strong>[예제 입력]<br/></strong>3 2 5<br/></p>
					<br/><br/>
					<p style="margin:2%;font-size:16px;line-height:1.5em;"><strong>[예제 출력]<br/></strong>35<br/></p>
					<br/><br/>
		</aside>
		<section>
				&nbsp;&nbsp;&nbsp;문제푸는 곳<br/>
