...
<html>
	...
	<form action="grader.php" method="post" id="form">
		<div id="name"><h2>문제<input name="no" value="<?php $url = basename($_SERVER['PHP_SELF']); $tok = explode('.', $url);	echo trim($tok[0]); ?>
					...
					?></h2></div>
		<aside>
			<p style="margin:2%;margin-right:6%;font-size:13px;line-height:1.5em;"><strong style="font-size:16px;">[문 제]</strong><br/><br/>한신이의 학교 앞 햄버거 가게에서는 특이한 세트 메뉴를 판매한다. 이 세트는 주문할 때, 자신이 원하는 햄버거와 음료를 하나씩 골라서 구성하는 메뉴이며 세트의 가격은 전체 합계에서 100원을 뺀 가격이 된다. 원하는 메뉴와 할인으로 인해 한신이는 주로 이 세트를 주문한다.<br/><br/>햄버거는 총 3종류로 치즈버거, 치킨버거, 불고기버거가 있고, 음료는 콜라와 사이다 두 종류가 있다. 햄버거와 음료의 가격이 주어졌을 때, 가장 싼 세트 메뉴의 가격을 출력하는 프로그램을 작성하시오.<br/><br/>입력은 다섯 줄이 들어오며, 처음 세 줄은 버거의 가격들, 나머지 두 줄은 콜라와 사이다의 가격이 주어진다. 모든 가격은 100원 이상, 2000원 이하이다.</p>
<br/>
					<p style="margin:2%;font-size:16px;line-height:1.5em;"><strong>[예제 입력]<br/></strong>800<br/>700<br/>900<br/>198<br/>330<br/>330<br/></p>
					<br/>
					<p style="margin:2%;font-size:16px;line-height:1.5em;"><strong>[예제 출력]<br/></strong>798<br/></p>
					<br/><br/>
		</aside>
		<section>
				&nbsp;&nbsp;&nbsp;문제푸는 곳<br/>
