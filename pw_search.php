    ...
    <section>
        <center>
			<div class="login_div">
				...
				<h2>비밀번호 찾기</h2> 
				<form name="pw_form" action="pw_search2.php" method="post">
				<table border="0" cellspacing="0"  height="200" width="500">
				<tr>
					<td  style="text-align:center">
						<input type="text" name="id" class="id" autofocus required placeholder="아이디" style="text-align:center; width:300px; height:40px;">
						<input type="text" name="name" class="pw" required placeholder="이름" style="text-align:center; width:300px; height:40px;">
					</td>
				</tr>
